  ...
  return (
    <div className="relative z-50">
      <label className="mb-3 block text-sm font-medium text-black dark:text-white">
        Select Tour/Tours (Multiple Selection)
      </label>
      <div>
        <select className="hidden" id={id}>
          <option value="1">Agra Heritage Tour</option>
          <option value="2">Kerala Backwaters Escape</option>
          <option value="3">Goa Beach Holiday</option>
          <option value="4">Jaipur Royal Retreat</option>
        </select>
